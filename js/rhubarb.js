...
const element = document.getElementById("section-readmore");
...
function openMenu() {
  ...
  menu.innerHTML =
    '<svg class="icon-close" focusable="false" viewBox="0 0 32 32" width="32" height="32" xmlns="http://www.w3.org/2000/svg">  <title>Close</title><path d="M16 14.586l6.364-6.364 1.414 1.414L17.414 16l6.364 6.364-1.414 1.414L16 17.414l-6.364 6.364-1.414-1.414L14.586 16 8.222 9.636l1.414-1.414z" fill="#fff"></path></svg>';
...
function closeMenu() {
  ...
  menu.innerHTML =
    '<div class="hamburger-row1"></div><div class="hamburger-row2"></div><div class="hamburger-row3"></div>';
